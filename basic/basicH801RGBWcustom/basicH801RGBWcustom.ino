...
void setup()
{
  ...
  Serial1.println("basicH801RGBW setup");
  delay(10);
  Serial1.println();
  Serial1.println();
...
void loop()
{
  ...
  if (client) {
      ...
      } else if((req.indexOf("/irgb/") != -1)) {
        fade = false;       
         
        // get RGB value
        int pos = req.length();
        int ind1 = req.indexOf("/irgb/") + 6;
        String teststring = req.substring(ind1, pos);
        int ind2 = teststring.indexOf("/");
        String hexRGB = req.substring(ind1, ind2+ind1);
      ...
      } else if((req.indexOf("/iw1/") != -1)) { 
        fade = false;       
         
        // get RGB value
        int pos = req.length();
        int ind1 = req.indexOf("/iw1/") + 5;
        String teststring = req.substring(ind1, pos);
        int ind2 = teststring.indexOf("/");
        String hexW1 = req.substring(ind1, ind2+ind1);
...
void InstantRed() {
  ...
  Serial1.print("instant red: "); Serial1.println(RED); 
}
void InstantGreen() {
  analogWrite(greenPIN, GREEN);
  Serial1.print("instant green: "); Serial1.println(GREEN);
}
void InstantBlue() {
  analogWrite(bluePIN, BLUE);
  Serial1.print("instant blue: "); Serial1.println(BLUE);
}
void InstantWhite() {
  analogWrite(w1PIN, W1);
  Serial1.print("instant white: "); Serial1.println(W1);
}

void LED_RED()
{
  if(RED != RED_A){
    Serial1.print("RED="); Serial1.print(RED); Serial1.print(" RED_A="); Serial1.println(RED_A);
...
{
  if(GREEN != GREEN_A){
    Serial1.print("GREEN="); Serial1.print(GREEN); Serial1.print(" GREEN_A="); Serial1.println(GREEN_A);
...
{
  if(BLUE != BLUE_A){
    Serial1.print("BLUE="); Serial1.print(BLUE); Serial1.print(" BLUE_A="); Serial1.println(BLUE_A);
...
{
  if(W1 != W1_A){
    Serial1.print("W1="); Serial1.print(W1); Serial1.print(" W1_A="); Serial1.println(W1_A);
...
{
  if(W2 != W2_A){
    Serial1.println("in LED_W2");
    Serial1.print("W2="); Serial1.print(W2); Serial1.print(" W2_A="); Serial1.println(W2_A);
