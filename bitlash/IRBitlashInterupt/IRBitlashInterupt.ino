...
//try putting rest and action code in functions called by irscriptstr and prxscriptstr
//String prxacttionstr = "function prxaction {j++;d8=!d8;if (j==6) j=0;}"
//String prxreststr = "function prxrest {d8=0;j=0;}"
//String iractionstr = "function iraction {i++;d9=!d9;if (i==6) {i=0;r=0;}}"
//String irreststr = "function irrest {d9=0;i=0;r=0;}"
//String irscriptstr  = "function irscript {if (!g) {irrest;} else if (r) {iraction;} snooze(1000);}";
//String prxscriptstr = "function prxscript {if (r || !g) {prxrest;} else {prxaction;} snooze(2000);}";
